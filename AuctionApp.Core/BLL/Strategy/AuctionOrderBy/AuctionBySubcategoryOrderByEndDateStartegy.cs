...
{
    public class AuctionBySubcategoryOrderByEndDateStartegy : IStrategy
    {
        readonly IAuctionRepo _auctionRepo;
        readonly IPaginationService _paginationService;

        public AuctionBySubcategoryOrderByEndDateStartegy(IPaginationService paginationService,
        ...
        public List<Item> GetAuctionsOrderBy(FilterAuctionDTO dto)
        {
            ...
            PaginationService.TotalCount = _auctionRepo.TakeAuctionsTotalCount(s => s.AuctionEndDate,
