...
/***/ "./Client/ts/orderButtonLinkActivator.ts":
/*!***********************************************!*\
  !*** ./Client/ts/orderButtonLinkActivator.ts ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _settings_constant__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../settings/constant */ \"./Client/ts/settings/constant.ts\");\n/* harmony import */ var _orderButtonLinkActivator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../orderButtonLinkActivator */ \"./Client/ts/orderButtonLinkActivator.ts\");\n/* harmony import */ var _categoryLinkActivator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../categoryLinkActivator */ \"./Client/ts/categoryLinkActivator.ts\");\n/* harmony import */ var _pagingLinkActivator__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../pagingLinkActivator */ \"./Client/ts/pagingLinkActivator.ts\");\n/* harmony import */ var _auctionClearSession__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../auctionClearSession */ \"./Client/ts/auctionClearSession.ts\");\n\r\n\r\n\r\n\r\n\r\n/*\r\n * Main - auctions.ts\r\n */\r\nconst categoryLinkActovator = new _categoryLinkActivator__WEBPACK_IMPORTED_MODULE_2__[\"default\"]($('#Categories'), 'active', _settings_constant__WEBPACK_IMPORTED_MODULE_0__[\"CATEGORY_KEY\"]);\r\ncategoryLinkActovator.init();\r\nconst buttonLinkActivator = new _orderButtonLinkActivator__WEBPACK_IMPORTED_MODULE_1__[\"default\"]($('#OrderByGroupButton'), 'active', _settings_constant__WEBPACK_IMPORTED_MODULE_0__[\"SORT_OPTION_KEY\"]);\r\nbuttonLinkActivator.init();\r\nconst pagingLinkActivator = new _pagingLinkActivator__WEBPACK_IMPORTED_MODULE_3__[\"default\"]($('#PaginationList'), 'active', _settings_constant__WEBPACK_IMPORTED_MODULE_0__[\"PAGING_KEY\"]);\r\npagingLinkActivator.init();\r\n_auctionClearSession__WEBPACK_IMPORTED_MODULE_4__[\"AuctionSession\"].clear();\r\n\n\n//# sourceURL=webpack:///./Client/ts/presentation/auctions.ts?");
